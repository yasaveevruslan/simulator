...
public class InitLogic
{
    ...
    public String[][] stands = new String[][] { 
            { "green", "red" },
            { "green", "red" },
            { "green", "red" },
            { "green", "red" } };
    ...
    public void addOrders(int palace)
    {
        String[] elements;
        ...
        for (int i = 0; i < 7; i++)
        {
            if (i < 4)
            {
                ...
                {
                    orders[palace][i] = elements[i];
                }
                else
                {
                    orders[palace][i] = "none";
                }
            }
            else
            {
                if (i == 4)
                {
                    orders[palace][i] = colorFirst;
                }
                else if(i == 5)
                {
                    orders[palace][i] = colorSecond;
                }else{
                    orders[palace][i] = colorThird;
