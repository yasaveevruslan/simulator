...
//                    new End(),
                    ...
                    new Odometry(States.ABSOLUTE_ODOMETRY, 4000, -1000, 0, SmoothEnum.OFF),
                    new Odometry(States.ABSOLUTE_ODOMETRY, 4000, 4000, 0, SmoothEnum.OFF),
                    new Odometry(States.ABSOLUTE_ODOMETRY, -8000, 4000, 0, SmoothEnum.OFF),
                    new Odometry(States.ABSOLUTE_ODOMETRY, 0, 0, 0, SmoothEnum.OFF),
                    new End(),
